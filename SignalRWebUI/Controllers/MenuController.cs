...
namespace SignalRWebUI.Controllers
{
    public class MenuController : Controller
    {
        ...
        public async Task<IActionResult> AddBasket(int id, int menuTableId)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7224/api/Basket", content);


            var client2 = _httpClientFactory.CreateClient();
            await client2.GetAsync("https://localhost:7224/api/MenuTables/ChangeMenuTableStatusToTrue?id=" + menuTableId);
